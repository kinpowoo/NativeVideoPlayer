...
public class P2pServiceManager {
    ...
    private boolean isLocalServiceRegister = false;
    ...
    public P2pServiceManager(Context context, ServiceStatusListener listener) {
        ...
        record.put("device_name", android.os.Build.MODEL);
