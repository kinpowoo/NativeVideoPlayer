...
public class WiFiDirectClient {
    ...
    private WeakReference<FileReceiveCallback> fileCallback;
    ...
    // 回调接口
    private WeakReference<ClientCallback> callback;
    ...
    public WiFiDirectClient(String serverHost, int serverPort,
