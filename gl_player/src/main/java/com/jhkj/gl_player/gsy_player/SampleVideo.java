...
public class SampleVideo extends StandardGSYVideoPlayer {
    ...
    private void initView() {
        mMoreScale = (TextView) findViewById(R.id.more_scale);
        TextView mChangeRotate = (TextView) findViewById(R.id.change_rotate);
...
//                mChangeTransform.setText("旋转镜像");
    ...
    public boolean setUp(String url, String title) {
        playUrl = url;
        return setUp(playUrl, false, title);
    }
