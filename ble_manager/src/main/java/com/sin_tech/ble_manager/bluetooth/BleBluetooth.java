package com.sin_tech.ble_manager.bluetooth;
...
import com.sin_tech.ble_manager.models.BleConnectStateParameter;
import com.sin_tech.ble_manager.models.BleDevice;
import com.sin_tech.ble_manager.models.BleMsg;
...
import com.sin_tech.ble_manager.protocols.exception.ConnectException;
import com.sin_tech.ble_manager.protocols.exception.OtherException;
import com.sin_tech.ble_manager.protocols.exception.TimeoutException;
...
public class BleBluetooth {
    ...
    public synchronized void disconnect() {
        ...
        disconnectGatt();
        closeBluetoothGatt();  //断开连接后要关闭gatt
    }
    ...
    private final BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            Iterator<Map.Entry<String,BleNotifyCallback>> iterator = bleNotifyCallbackHashMap.entrySet().iterator();
            while (iterator.hasNext()) {
                Map.Entry<String,BleNotifyCallback> entry = iterator.next();
            ...
            Iterator<Map.Entry<String,BleIndicateCallback>> iterator2 = bleIndicateCallbackHashMap.entrySet().iterator();
            while (iterator.hasNext()) {
                Map.Entry<String,BleIndicateCallback> entry = iterator2.next();
